...
const routes = [
    ...
    {
        path: 'waiting',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_waiting_waiting_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/waiting/waiting.module */ 3849)).then(m => m.WaitingPageModule)
    },
];
  ...
  initialize() {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.platform.ready().then( /*#__PURE__*/function () {
        var _ref = (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (readySource) {
...
let AvatarService = class AvatarService {
  constructor(auth, firestore, storage, overlay, nav, router, authService) {
    var _this = this;
    ...
    const sub = this.auth.onAuthStateChanged(user => {
      if (user) {
        this.driverCollection = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.firestore, 'Drivers');
        console.log(user);
        this.subscription = this.CheckProfile(user).subscribe( /*#__PURE__*/function () {
          var _ref = (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
            if (data) if (data.Rider_name) {
              ...
              _this.overlay.showAlert('Another Account', 'Cannot sign in as both a rider and driver on one account. Use another phone number');
            }
        ...
        this.subscription2 = this.getUserProfile(user).subscribe( /*#__PURE__*/function () {
          var _ref2 = (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
            ...
            if (_this.profile) {
              if (!_this.profile.Driver_phone) // await this.authService.logout();
                if (_this.profile.Driver_name) {
                  _this.userName = _this.profile.Driver_name;
                } else {
                  _this.nav.navigateForward('details');
                }

              if (_this.profile.Approved == false) {
                _this.nav.navigateForward('waiting');
              }
  ...
  RequestRideWithRiderDetails(user_Loc_coord, user_Des_coord, ID) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this2.firestore, 'Drivers', ID);
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)(userDocRef, {
          onlineState: false
        });
        console.log('deleted current driver ID');
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this2.firestore, "Request", ID), { ...loc
        });
  ...
  createHistory(user) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this6.firestore, "Drivers", `${_this6.auth.currentUser.uid}/History/${user.Rider_id}`), { ...loc
        });
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this6.firestore, "AllRides", `${_this6.auth.currentUser.uid}/customer/${user.Rider_id}`), { ...loc
        });
      } catch (e) {
        alert(e);
      }
  ...
  goOffline() {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.deleteDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this7.firestore, "Drivers", _this7.auth.currentUser.uid));
    })();
  ...
  UpdateCountDown(time) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this9.firestore, "Request", _this9.auth.currentUser.uid);
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)(userDocRef, {
          countDown: time
        });
        return true;
  ...
  PushDriverToRequest(coord, name, email, phone, car, cartype, plate, imageUrl, document) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this10.firestore, "Request", _this10.auth.currentUser.uid), { ...loc
        });
      } catch (e) {
        throw new Error(e);
      }
  ...
  CreateNewDriver(coord, name, email, phone, car, cartype, plate, imageUrl, document) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this11.firestore, "Drivers", _this11.auth.currentUser.uid), { ...loc
        });
      } catch (e) {
        throw new Error(e);
      }
  ...
  uploadImage(cameraFile, uid) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const storageRef = (0,_angular_fire_storage__WEBPACK_IMPORTED_MODULE_5__.ref)(_this12.storage, _this12.pathM);

      try {
        yield (0,_angular_fire_storage__WEBPACK_IMPORTED_MODULE_5__.uploadString)(storageRef, cameraFile.base64String, 'base64');
        const imageUrl = yield (0,_angular_fire_storage__WEBPACK_IMPORTED_MODULE_5__.getDownloadURL)(storageRef);
        const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this12.firestore, `Drivers/${uid}`);
  ...
  uploadDocImages(cameraFile) {
    var _this13 = this;

    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const storageRef = (0,_angular_fire_storage__WEBPACK_IMPORTED_MODULE_5__.ref)(_this13.storage);
  ...
  getDocs() {
    const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.firestore, `Drivers/${this.auth.currentUser.uid}/Documents`);
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collectionData)(userDocRef);
  }

  getEarnings(uid) {
    const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(this.firestore, `Drivers/${uid}`);
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.docData)(userDocRef);
  }

  getCartypes() {
    const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.firestore, `Cartypes`);
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collectionData)(userDocRef);
  }

  getDocuments() {
    const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.firestore, `Documents`);
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collectionData)(userDocRef);
  }

  getHistory() {
    const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.firestore, "Drivers", `${this.auth.currentUser.uid}/History`);
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collectionData)(userDocRef);
  }

  getRequests() {
    const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(this.firestore, `Request/${this.auth.currentUser.uid}`);
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.docData)(userDocRef);
  }
  ...
  addChatMessage(msg) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.addDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(_this14.firestore, `Messages/${_this14.profile.Driver_id}/messages`), {
        msg: msg,
  ...
  updateMessageInfo() {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this15.firestore, `Messages/${_this15.profile.Driver_id}`), {
  ...
  createCard(name, number, type, id) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this16.firestore, "Drivers", `${_this16.auth.currentUser.uid}/Cards/${name}`), { ...loc
        });
        return true;
      } catch (e) {
        alert(e);
  ...
  updateCArd(name, number, type, id, state) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this17.firestore, "Drivers", `${_this17.profile.Rider_id}/Cards/${name}`), { ...loc
        });
        return true;
      } catch (e) {
        alert(e);
  ...
  updateOnlineState(state) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this18.firestore, 'Drivers', `/${_this18.auth.currentUser.uid}/`);
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)(userDocRef, {
          onlineState: state
        });
        return true;
  ...
  updateEarnings(value) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        const userDocRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this19.firestore, 'Drivers', `/${_this19.auth.currentUser.uid}/`);
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)(userDocRef, {
          Earnings: value
        });
        return true;
  ...
  createDocument(name, type, id, image, text) {
    ...
    return (0,_Users_chineduetoh_Desktop_IONIC_PROJECTS_myDriver_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.setDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(_this20.firestore, "Drivers", `${_this20.auth.currentUser.uid}/Documents/${name}`), { ...loc
        });
        return true;
      } catch (e) {
        alert(e);
...
AvatarService = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Injectable)({
  providedIn: 'root'
})], AvatarService);
...
"use strict";
module.exports = "ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color, #fff));\n}\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px;\n}\n\nion-menu.md ion-list {\n  padding: 20px 0;\n}\n\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #d7d8da);\n}\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  min-height: 70px;\n  margin-bottom: 16px;\n}\n\n.allItems {\n  margin-top: 8px;\n  font-size: 19px;\n}\n\n.allItems ion-icon {\n  font-size: 29px;\n}\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 20px;\n  margin-bottom: 90px;\n  color: #757575;\n  min-height: 20px;\n}\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-primary-rgb), 0.14);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.md ion-item ion-icon {\n  color: #616e7e;\n}\n\nion-menu.md ion-item ion-label {\n  font-weight: 500;\n}\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0;\n}\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: #73849a;\n}\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: var(--ion-color-medium-shade);\n}\n\nion-item.selected {\n  --color: var(--ion-color-primary);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
